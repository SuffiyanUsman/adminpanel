...
const AllWorkersProfile = React.lazy(() => import('./views/worker/AllWorker'))
const AddNewWorker = React.lazy(() => import('./views/worker/AddWorker'))
...
const routes = [
  ...
  { path: '/workers', name: 'Worker', component: AllWorkersProfile, exact: true },
  { path: '/workers/all-workers', name: 'All Workers', component: AllWorkersProfile },
  { path: '/workers/add-new-worker', name: 'Add New Worker', component: AddNewWorker },
  { path: '/workers/update-worker/:id',pathSimpleName:"/worker/update-worker" , name: 'Update Worker', component: UpdateWorker },
  { path: '/workers/view-worker/:id', name: 'View Worker', component: ViewWorkerProfile },

  { path: '/users', name: 'User', component: AllUser, exact: true },
  { path: '/users/all-users', name: 'All Users', component: AllUser },
  { path: '/users/add-new-user', name: 'Add New User', component: AddNewUser },
